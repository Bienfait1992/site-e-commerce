...
<div className="ring-1 ring-black mt-10 ring-opacity-15 flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl mb-4">
    <div className="flex flex-row gap-3 pb-4">
        <div>
            <img src="src/images/logo/biso243_logo.png" alt=""  className="w-32"/>
            {/* <img src="/favicon.svg" width="50" alt="Logo"> */}
        </div>
         <h1 className="text-3xl font-bold text-[#4B5563] text-[#4B5563] my-auto">BISO 243 </h1>

    </div>
    <div className="text-sm font-light text-[#6B7280] pb-8 ">Connectez-vous pour continuer.</div>
    <form className="flex flex-col">
        ...
        <button type="submit" className="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">se connecter</button>
        <div className="text-sm font-light text-[#6B7280] ">Vous n'avez pas encore de compte ? <a href="/inscription" className="font-medium text-[#4F46E5] hover:underline">S'inscrire</a>
